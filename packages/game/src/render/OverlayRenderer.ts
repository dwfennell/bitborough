...
import { landValueToRgba, crimeToRgba, fireCoverageToRgba, trafficToRgba, educationQualityToRgba } from './colors.js'
...
const EDUCATION_QUALITY_COLORS = buildColorTable(educationQualityToRgba)
