...
const SECTIONS: DocSection[] = [
  ...
  },
  {
    ...
    content: `
      <table>
        <tr><td><strong>Arrow Keys</strong></td><td>Pan camera</td></tr>
        <tr><td><strong>Scroll Wheel</strong></td><td>Zoom in/out</td></tr>
        <tr><td><strong>Q / W</strong></td><td>Zoom out / Zoom in</td></tr>
        ...
        <tr><td><strong>A / S</strong></td><td>Decrease / Increase game speed</td></tr>
...
export class DocsPanel {
  ...
  private sectionEls: { el: HTMLElement; title: string; text: string }[] = []
