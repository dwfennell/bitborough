...
export const demand: DocSection = {
  ...
  body: [
    ...
    '',
    '**Residential** demand is strong — people always want to move in, modified by the tax rate.',
    '',
    '`R Demand = 1.0 × Tax Modifier`',
    '',
    '**Commercial** demand scales with your residential capacity — shops need customers. It caps at 0.6:',
    '',
    '`C Demand = min(Res Capacity ÷ 500, 0.6) × Tax Modifier`',
    '',
